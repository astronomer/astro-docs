...
Note that this installation requires the use of [Docker](https://www.docker.com/) (v18.09 or higher).
...
- You're in the directory for the correct Workspace.
...
### Review the Astronomer Certified System Distribution
