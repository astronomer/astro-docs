...
| `ContainerMemoryNearTheLimitInDeployment` | A container in your Aiirflow Deployment is near its memory quota; it's been using over 95% of it's memory quota for over 60 minutes. | Either increase the Deployment's allocated resources in the Astrnomer UI or update your DAGs to use less resources. If you have not already done so, upgrade to [Airflow 2.0](https://www.astronomer.io/blog/introducing-airflow-2-0) for improved resource management. |
