...
Run `astro deployment airflow upgrade --deployment-id` to initialize the Airflow upgrade process. To finalize the Airflow upgrade process, complete all of the steps as described in [Upgrade Apache Airflow on Astronomer](https://www.astronomer.io/docs/cloud/stable/customize-airflow/manage-airflow-versions).
...
- [Manage User Permissions on Astronomer](https://www.astronomer.io/docs/cloud/stable/manage-astronomer/workspace-permissions)
...
- [Configure an Airflow Deployment on Astronomer](https://www.astronomer.io/docs/cloud/stable/deploy/manage-workspaces)
- [Integrate IAM Roles](https://www.astronomer.io/docs/cloud/stable/customize-airflow/integrate-iam)
...
- [CLI Quickstart](https://www.astronomer.io/docs/cloud/stable/develop/cli-quickstart)
