...
**Note:** We use Ubuntu as our Linux flavor of choice, but this guide should work for other distrubutions as well.
...
Once you've completed the steps above, head over to our [CLI Quickstart Guide](/docs/cloud/stable/develop/cli-quickstart/) to finish the installation and start deployment DAGs.
