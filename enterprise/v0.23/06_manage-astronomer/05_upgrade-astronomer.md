...
For a detailed breakdown of individual releases, refer to [Astronomer Enterprise Release Notes](https://www.astronomer.io/docs/enterprise/v0.23/resources/release-notes/).
...
If you're looking to upgrade to Astronomer Enterprise [v0.16 (latest)](/docs/enterprise/v0.23/resources/release-notes) from an earlier minor version, submit a request to [Astronomer Support](https://support.astronomer.io).
