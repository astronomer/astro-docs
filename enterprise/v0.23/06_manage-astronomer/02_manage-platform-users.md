...
In addition to Workspace-level [role-based access control (RBAC) functionality](/docs/enterprise/v0.23/manage-astronomer/workspace-permissions/) core to our platform, Astronomer Enterprise allows teams to customize *how* they want users to create accounts on Astronomer and what they're able to do on the platform - both on Astronomer and Airflow.
