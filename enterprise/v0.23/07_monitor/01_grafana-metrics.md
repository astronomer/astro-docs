...
If you're interested in customizing the pre-built dashboards to create other views or compile additional metrics, skip to [Creating Custom Dashboards](/docs/enterprise/v0.23/monitor/grafana-metrics#create-a-custom-grafana-dashboard).
