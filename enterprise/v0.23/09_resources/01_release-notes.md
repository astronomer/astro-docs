...
For instructions on how to upgrade to an Astronomer v0.23 patch version, read [Upgrade to a Patch Version](/docs/enterprise/v0.23/manage-astronomer/upgrade-patch/).
