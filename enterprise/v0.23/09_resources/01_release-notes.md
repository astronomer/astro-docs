...
- Fixed an issue where the v0.23 upgrade script would throw an error when upgrading the Astronomer Postgres DB. ([Source](https://github.com/astronomer/astronomer/pull/1050))
