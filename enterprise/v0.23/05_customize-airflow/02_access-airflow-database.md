...
If you want to store this connection and access it programmatically, you're also free to store it in a [Secret Backend](/docs/enterprise/v0.23/customize-airflow-secrets-backend).
