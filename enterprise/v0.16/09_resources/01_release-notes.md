...
#### Support for Latest Builds of Astronomer Core

Astronomer v0.16.9 also includes support for:

- AC 1.10.10-5 ([Changelog](https://github.com/astronomer/core/blob/master/1.10.10/CHANGELOG.md))
- AC 1.10.7-15 ([Changelog](https://github.com/astronomer/core/blob/master/1.10.7/CHANGELOG.md))
- AC 1.10.5-11 ([Changelog](https://github.com/astronomer/core/blob/master/1.10.5/CHANGELOG.md))
...
Astronomer Enterprise v0.16.5 includes support for the following patch releases of Astronomer Core (AC), our distribution of Apache Airflow:

- [1.10.5-10](https://github.com/astronomer/core/blob/master/1.10.5/CHANGELOG.md)
- [1.10.7-14](https://github.com/astronomer/core/blob/master/1.10.7/CHANGELOG.md)
- [1.10.10-4](https://github.com/astronomer/core/blob/master/1.10.10/CHANGELOG.md)
...
To be notified of AC releases, feel free to [subscribe to our AC Newsletter](/downloads/). For information on how to upgrade Astronomer Core versions, refer to our ["Manage Airflow Versions" doc](/docs/enterprise/v0.16/customize-airflow/manage-airflow-versions/).
