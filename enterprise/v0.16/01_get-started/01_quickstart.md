...
**Note:** The `curl` command will work for Unix (Linux+Mac) based systems. If you want to run on Windows 10, you'll need to run through [this guide](https://www.astronomer.io/docs/enterprise/v0.16/develop/cli-install-windows-10//) on getting Docker for WSL working.
