...
2. Follow the instructions for requesting a certificate from your organization's security team as described in [Configure SSL](https://www.astronomer.io/docs/enterprise/v0.16/install/aws/install-aws-standard#4-configure-ssl). The linked guide is for setting up with AWS, but this step is the same regardless of which service you use.
