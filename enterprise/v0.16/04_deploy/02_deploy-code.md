...
1. [The Astronomer CLI](/docs/enterprise/v0.16/develop/cli-quickstart/) Installed
...
For more information on what gets built into your image, jump over to our doc on [Customizing your Image](/docs/enterprise/v0.16/develop/customize-image/).
