...
2. [Create a Service Account](/docs/enterprise/v0.16/deploy/ci-cd#step-1-create-a-service-account) for your Astronomer Workspace.
...
4. Go to the Actions tab of your GitHub repo and create a new action with a `main.yml` file. To achieve the recommended workflow described in [Overview](/docs/enterprise/v0.16/deploy/ci-cd#overview), use the following action:
