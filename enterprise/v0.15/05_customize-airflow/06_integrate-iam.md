...
2. Push the configuration change to your platform as described in [Apply a Platform Configuration Change on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/apply-platform-config).
...
Add the following to your `config.yaml` file and push it to your platform as described in [Apply a Config Change](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/apply-platform-config):
