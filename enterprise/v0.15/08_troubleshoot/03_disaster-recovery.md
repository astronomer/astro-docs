...
- [Install Astronomer on GCP](/docs/enterprise/v0.15/install/gcp/install-gcp-standard/)
- [Install Astronomer on AWS](/docs/enterprise/v0.15/install/aws/install-aws-standard/)
