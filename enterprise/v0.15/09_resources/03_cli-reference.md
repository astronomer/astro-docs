...
For a detailed changelog for all Astronomer CLI versions, see [GitHub Releases](https://github.com/astronomer/astro-cli/releases).
...
- [Apply a Platform Configuration Change on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/apply-platform-config)
...
- [Deploy to Astronomer via the CLI](https://www.astronomer.io/docs/enterprise/v0.15/deploy/deploy-cli)
...
- [Configure an Airflow Deployment on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/deploy/manage-workspaces)
...
Run `astro deployment airflow upgrade --deployment-id` to initialize the Airflow upgrade process. To finalize the Airflow upgrade process, complete all of the steps as described in [Upgrade Apache Airflow on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/customize-airflow/manage-airflow-versions).
...
- [Upgrade Apache Airflow on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/customize-airflow/manage-airflow-versions)
- [Manage User Permissions on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/workspace-permissions)
...
- [Configure an Airflow Deployment on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/deploy/manage-workspaces)
- [Integrate IAM Roles](https://www.astronomer.io/docs/enterprise/v0.15/customize-airflow/integrate-iam)
...
- [Deployment Logs](https://www.astronomer.io/docs/enterprise/v0.15/deploy/deployment-logs)
...
- [Deploy to Astronomer via CI/CD](https://www.astronomer.io/docs/enterprise/v0.15/deploy/ci-cd)
...
- [Access to the Airflow CLI](https://www.astronomer.io/docs/enterprise/v0.15/develop/customize-image#access-to-the-airflow-cli)
...
- [Upgrade to Apache Airflow 2.0 on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/customize-airflow/upgrade-to-airflow-2)
...
- [Manage Workspace Permissions on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/workspace-permissions)
- [Manage Users on Astronomer Enterprise](https://www.astronomer.io/docs/enterprise/v0.15/manage-astronomer/manage-platform-users)
...
- [CLI Quickstart](https://www.astronomer.io/docs/enterprise/v0.15/develop/cli-quickstart)
...
- [Manage Workspaces and Deployments on Astronomer](https://www.astronomer.io/docs/enterprise/v0.15/deploy/manage-workspaces)
