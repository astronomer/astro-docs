...
When you are ready to deploy this up into Astronomer, follow the [KubePodOperator doc](/docs/enterprise/v0.12/customize-airflow/kubepodoperator/) to find a list of the necessary changes that will need to be made.