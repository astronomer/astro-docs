...
> **Note:** Both methods only work for Unix (Linux+Mac) based systems. If you're running on Windows 10, follow [this guide](https://www.astronomer.io/docs/enterprise/v0.12/develop/cli-install-windows-10/) to get set up with Docker for WSL.
...
- **Postgres:** [Airflow's Metadata Database](https://www.astronomer.io/docs/enterprise/v0.12/customize-airflow/access-airflow-database/)
...
For guidelines on accessing your Postgres database both locally and on Astronomer, refer to our ["Airflow Database" doc](https://www.astronomer.io/docs/enterprise/v0.12/customize-airflow/access-airflow-database/).
...
* [Deploying to Astronomer](https://www.astronomer.io/docs/enterprise/v0.12/deploy/deploy-code/)
* [Customizing your Image](https://www.astronomer.io/docs/enterprise/v0.12/develop/customize-image/)
* [Managing Airflow Versions](https://www.astronomer.io/docs/enterprise/v0.12/customize-airflow/airflow-versioning/)
* [CI/CD](https://www.astronomer.io/docs/enterprise/v0.12/deploy/ci-cd/)
