...
> **Note:** In order for a Service Account to have permission to push code to your Airflow Deployment, it must have either the "Editor" or "Admin" role. For more information on Workspace roles, refer to our ["Roles and Permissions"](https://www.astronomer.io/docs/enterprise/v0.12/manage-astronomer/workspace-permissions/) doc.
