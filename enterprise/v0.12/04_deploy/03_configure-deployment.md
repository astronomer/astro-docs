...
The **Extra Capacity** setting is tied to the [KubernetesPodOperator](/docs/enterprise/v0.12/customize-airflow/kubepodoperator/) and the KubernetesExecutor, as it maps to extra pods created in the cluster. Namely, the slider affects:
...
- ["Environment Variables on Astronomer"](/docs/enterprise/v0.12/deploy/environment-variables/) Doc
