...
> **Note:** For our platform's full collection of Docker Images, reference [Astronomer on Quay.io](https://quay.io/repository/astronomer/core?tab=tags).

| Airflow Version | Alpine-based Image                          | Debian-based Image
|-----------------|-----------------------------------------------------|-----------------------------------------------------|
| [v1.10.5](https://github.com/apache/airflow/releases/tag/1.10.5)         | FROM quay.io/astronomer/core:1.10.5-alpine3.10-onbuild | FROM quay.io/astronomer/core:1.10.5-buster-onbuild |
| [v1.10.7](https://github.com/apache/airflow/releases/tag/1.10.7)         | FROM quay.io/astronomer/core:1.10.7-alpine3.10-onbuild | FROM quay.io/astronomer/core:1.10.7-buster-onbuild |
