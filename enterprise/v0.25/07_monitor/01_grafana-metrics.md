...
If you're interested in customizing the pre-built dashboards to create other views or compile additional metrics, skip to [Creating Custom Dashboards](/docs/enterprise/v0.25/monitor/grafana-metrics#create-a-custom-grafana-dashboard).

## Access Grafana

By default, users with [System Admin permissions](https://www.astronomer.io/docs/enterprise/v0.25/manage-astronomer/manage-platform-users#system-roles) can access Grafana. To access Grafana from the Astronomer UI:
