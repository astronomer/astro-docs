...
On Astronomer, resources required for the [KubernetesPodOperator](https://www.astronomer.io/docs/enterprise/v0.25/customize-airflow/kubepodoperator) or the [Kubernetes Executor](/docs/enterprise/v0.25/customize-airflow/kubernetes-executor) are set as **Extra Capacity**.
...
To deploy DAGs to a Deployment via an NFS volume, you must first enable the feature at the platform level. For more information, read [Deploy DAGs via NFS Volume](/docs/enterprise/v0.25/manage-astronomer/configure-nfs).
