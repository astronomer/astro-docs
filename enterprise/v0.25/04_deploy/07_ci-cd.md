...
> **Note:** In order for a Service Account to have permission to push code to your Airflow Deployment, it must have either the "Editor" or "Admin" role. For more information on Workspace roles, refer to our ["Roles and Permissions"](/docs/enterprise/v0.25/manage-astronomer/workspace-permissions/) doc.
...
2. [Create a Service Account](/docs/enterprise/v0.25/deploy/ci-cd#step-1-create-a-service-account) for your Astronomer Workspace.
...
4. Go to the Actions tab of your GitHub repo and create a new action with a `main.yml` file. To achieve the recommended workflow described in [Overview](/docs/enterprise/v0.25/deploy/ci-cd#overview), use the following action:
