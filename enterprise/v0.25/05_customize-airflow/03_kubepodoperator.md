...
If you're using the Kubernetes Executor, you can also configure task-level Kubernetes resources using a pod template. For more information, read [Use a Pod Template in a Task](/docs/enterprise/0.25/customize-airflow/kubernetes-executor#use-a-pod-template-in-a-task).
