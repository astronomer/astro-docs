...
This guide focuses on configuring task and DAG-level alerts. For information on configuring platform and Deployment-level alerts, read [Alerting on Astronomer Enterprise](https://www.astronomer.io/docs/enterprise/v0.25/monitor/platform-alerts).
...
> **Note:** For more information on how to configure Environment Variables both locally and on Astronomer, refer to [Environment Variables](https://www.astronomer.io/docs/enterprise/v0.25/deploy/environment-variables/).
...
5. Open your Airflow Deployment in the Astronomer UI and go to the **Variables** tab. Then, add the following Environment Variables using the **+Add** button:
   ...
   To prevent unauthorized users in your Workspace from seeing sensitive information, we recommend selecting the **Secret?** checkbox for your email and password profile variables.
    ...
    > **Note:** For more information on how to configure Environment Variables both locally and on Astronomer, refer to our ["Environment Variables" doc](https://www.astronomer.io/docs/enterprise/v0.25/deploy/environment-variables/).
