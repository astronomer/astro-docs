...
Once you've saved your `config.yaml` file with these values, push it to your platform as described in [Apply a Config Change](/docs/enterprise/v0.25/manage-astronomer/apply-platform-config).
