...
For more details on this new feature, reference our ["Environment Variables" doc](/docs/enterprise/v0.14/deploy/environment-variables/).
...
To learn more, reference ["Auth Systems on Astronomer"](/docs/enterprise/v0.14/manage-astronomer/integrate-auth-system/).
