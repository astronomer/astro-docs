...
Once you've completed the steps above, head over to our [CLI Quickstart Guide](https://www.astronomer.io/docs/cli-quickstart/) to finish the installation and start deployment DAGs.
