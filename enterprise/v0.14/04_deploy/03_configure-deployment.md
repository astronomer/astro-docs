...
The **Extra Capacity** setting is tied to the [KubernetesPodOperator](/docs/enterprise/v0.14/customize-airflow/kubepodoperator/) and the KubernetesExecutor, as it maps to extra pods created in the cluster. Namely, the slider affects:
