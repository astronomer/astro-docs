...
1. [The Astronomer CLI](https://www.astronomer.io/docs/enterprise/v0.14/develop/cli-quickstart/) Installed
...
For more information on what gets built into your image, jump over to our doc on [Customizing your Image](https://www.astronomer.io/docs/enterprise/v0.14/develop/customize-image/).
