...
Check out our `Customizing Your Install` section for guidance on setting an [auth system](/docs/enterprise/v0.14/manage-astronomer/integrate-auth-system/) and [resource requests](https://www.astronomer.io/docs/ee-configuring-resources/) in this `config.yaml`.
