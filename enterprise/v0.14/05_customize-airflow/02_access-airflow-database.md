...
If you want to store this connection and access it programmatically, you're also free to store it in a [Secret Backend](https://www.astronomer.io/docs/enterprise/stable/customize-airflow-secrets-backend).
