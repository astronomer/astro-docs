...
- [Install Astronomer on GCP](/docs/enterprise/v0.14/install/gcp/install-gcp-standard/)
- [Install Astronomer on AWS](/docs/enterprise/v0.14/install/aws/install-aws-standard/)
