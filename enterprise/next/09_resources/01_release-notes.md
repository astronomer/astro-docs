...
For instructions on how to upgrade to a patch version, read [Upgrade to a Patch Version](/docs/enterprise/stable/manage-astronomer/upgrade-patch/).
...
For step-by-step guidelines, refer to ["Forward Logs to S3"](https://www.astronomer.io/docs/enterprise/stable/monitor/logs-to-s3/).
...
For more information on alerts that are generated by default, refer to our ["Alerts" doc](/docs/enterprise/stable/monitor/platform-alerts/).

> **Note:** These alerts are NOT Airflow task-level alerts that require definition at the Airflow code level. For more information on how to set up `email_on_failure` within Airflow, for example, refer to our ["Airflow Alerts" doc](/docs/enterprise/stable/customize-airflow/airflow-alerts/).
