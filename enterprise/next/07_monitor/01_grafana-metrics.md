...
Astronomer takes metrics generated by Statsd, as well as metrics generated from the KubeAPI by Prometheus and funnels them into Grafana dashboards where you can see the status of all Airflow deployments on your cluster.
...
Additionally, you can customize your own dashboards to compile metrics that appear across separate release dashboards, or to compile metrics that don't yet appear in release dashboards. For more information, read [Creating Custom Dashboards](/docs/enterprise/next/monitor/grafana-metrics#creating-custom-dashboards).
