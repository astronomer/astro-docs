...
* Expect to see each of your underlying nodes in the EC2 console.
   * Given Astronomer's default resource requests of ~11 CPUs and ~40GB of memory, we recommend using 6 [m5.xlarge](https://aws.amazon.com/ec2/instance-types/) nodes for your cluster. To modify Astronomer's default resource requests, see step 6.
