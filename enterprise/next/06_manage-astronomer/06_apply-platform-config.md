...
> **Note:** If you're interested in upgrading Astronomer to a new version of the platform, read [Upgrade to a Patch Version](https://www.astronomer.io/docs/enterprise/stable/manage-astronomer/upgrade-patch).
