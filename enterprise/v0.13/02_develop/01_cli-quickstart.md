...
> **Note:** Both methods only work for Unix (Linux+Mac) based systems. If you're running on Windows 10, follow [this guide](/docs/enterprise/v0.13/develop/cli-install-windows-10/) to get set up with Docker for WSL.
...
- **Postgres:** [Airflow's Metadata Database](/docs/enterprise/v0.13/customize-airflow/access-airflow-database/)
...
For guidelines on accessing your Postgres database both locally and on Astronomer, refer to our ["Airflow Database" doc](/docs/enterprise/v0.13/customize-airflow/access-airflow-database/).
