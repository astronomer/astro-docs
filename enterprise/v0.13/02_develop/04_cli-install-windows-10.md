...
Once you've completed the steps above, head over to our [CLI Quickstart Guide](/docs/enterprise/v0.13/develop/cli-quickstart/) to finish the installation and start deployment DAGs.
