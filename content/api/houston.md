...
Astronomer's [Houston API](https://github.com/astronomer/houston-api) is the source of truth across the entire Astronomer Enterprise platform. 

For Astronomer Enterprise users, our API is an easy way to do any of the following:

1. Query your platform's database for information about a user, Workspace, or Deployment
2. Make changes to anything in your platform's database
...
If you are an Astronomer Enterprise customer, your Playground will be located at: https://houston.BASEDOMAIN/v1/

E.g. If your basedomain were `Astronomer`, you would navigate to https://houston.astronomer/v1/. 
