...
Astronomer Certified currently supports Airflow version 1.10.7. This doc should cover everything you need to know to run Astronomer Certified via either method, including:
...
```
sudo -u astro ~astro/airflow-venv/bin/pip install --extra-index-url=https://pip.astronomer.io/simple/ 'astronomer-certified[postgres]==1.10.7.*'
```
